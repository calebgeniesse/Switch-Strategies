...
class Strategy(strategy_template.Strategy):
    def __init__(self):
        ...
        self.default_params_ = [3, 0, 0, 0, 2, 0, 0, 1, 0, 0, 3, -0.5]
    ...
    def giveReward(self, seq1, strech1, seq2, strech2,
                   stongReward, normalReward, weakReward,
    ...
    def score(self, design, params):
        ...
        if "miRNA" not in design['labtitle']:
            ...
            self.giveReward(seq, s2, seq, s1,
                            params[0], params[1], params[2])
            self.giveReward(seq, s2, seq, s3,
                            params[3], params[4], params[5], True)
            self.giveReward(seq, s4, seq, s3,
                            params[6], params[7], params[8], False, True)
            self.giveReward(seq, s4, oligo, s5,
