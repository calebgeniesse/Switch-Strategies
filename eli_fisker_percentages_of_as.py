...
class Strategy(strategy_template.Strategy):
    def __init__(self):
        ...
        self.default_params_ = [0.29, 0.35, 0.31, 0.33, 1, 2, 1.0, 1.0]
    ...
    def score(self, design, params):
        ...
        if perA > params[1]: score -= ((perA - params[1])*100*params[6])
        if perA < params[0]: score -= ((params[0] - perA)*100*params[7])
